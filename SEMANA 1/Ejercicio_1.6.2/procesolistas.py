...
def promedio(lista):
    """
    Calcula el promedio simple de todos los elementos de una lista
    
    :param lista: lista de valores 
    :type lista: lista de datos que soporte suma y división
    :returns: el promedio de los elementos de la lista
    :rtype: float
    """
...
def existe(lista, buscado):
    ...
    :tipo buscado: el musmo tipo que el de los datos almacenados en la lista
